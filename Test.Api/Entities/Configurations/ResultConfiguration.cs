...
public class ResultConfiguration : EntityBaseConfiguration<Result>
{
    public override void Configure(EntityTypeBuilder<Result> builder)
    {
        ...
        builder.Property(b => b.Id)
            ...
            .ValueGeneratedOnAdd();
        builder.HasOne<User>(e => e.User).WithMany(e => e.Results).HasForeignKey(e => e.UserId).OnDelete(DeleteBehavior.Cascade);;
        builder.HasOne<Test>(e => e.Test).WithMany(e => e.Results).HasForeignKey(e => e.TestId).OnDelete(DeleteBehavior.Cascade);;
