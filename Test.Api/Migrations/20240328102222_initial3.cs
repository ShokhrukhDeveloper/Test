        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedOpionId = table.Column<int>(type: "integer", nullable: false),
                    CorrectOpionId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Answers_Options_CorrectOpionId",
                        column: x => x.CorrectOpionId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Answers_CorrectOpionId",
                table: "Answers",
                column: "CorrectOpionId");
